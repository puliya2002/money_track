...
import 'business_category_dropdown_income.dart';

class BusinessAddTransactionFormIncome extends StatefulWidget {
  const BusinessAddTransactionFormIncome({super.key});

  @override
  State<BusinessAddTransactionFormIncome> createState() => _BusinessAddTransactionFormIncomeState();
}

class _BusinessAddTransactionFormIncomeState extends State<BusinessAddTransactionFormIncome> {
  var type = "Credit"; // Changed initial value to 'Credit'
  var category = "Product Sales";
      ...
      child: Form(
        ...
        child: Column(
          children: [
            ...
            BusinessCategoryDropDownIncome(
              cattype: category,
